...
# input parameters
@Gooey(required_cols=3, program_name='CpG island identificator single-fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description="identify CpG islands on single-fasta files based on the Gardiner-Garden and Frommer (1987) method")
